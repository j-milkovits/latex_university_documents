    ...
    \begin{itemize}
        \item \textit{Beispiel 1:}
            \begin{itemize}
                \item[]
                    \begin{minipage}{0.5\textwidth}
                        \includegraphics[height=5cm]{bsp1Code.PNG}
                    \end{minipage}
                    \begin{minipage}{0.4\textwidth}
                        \includegraphics[height=7cm]{bsp1Ass.PNG}
                    \end{minipage}
        ...
        \item \textit{Beispiel 2:}
            \begin{itemize}
                \item[]
                    \begin{minipage}{0.5\textwidth}
                        \includegraphics[height=5cm]{bsp2Code.PNG}
                    \end{minipage}
                    \begin{minipage}{0.4\textwidth}
                        \includegraphics[height=7cm]{bsp2Ass.PNG}
                    \end{minipage}
