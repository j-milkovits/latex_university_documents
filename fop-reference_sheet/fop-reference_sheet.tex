...
\section{Graphical User Interface}
	...
	\makecell[l]{Window Manager} & \makecell[l]{$\rhd$ Systemprozess, der permanent im Hintergrund als \texttt{Service} läuft \\
	...
	\makecell[l]{Klasse Frame} & \makecell[l]{$\rhd$ Abgeleitet von \texttt{java.awt.Window;} (awt = abstract window toolkit) \\
	...
	\makecell[l]{Komponenten} & \makecell[l]{$\rhd$ Eigene Klasse für jede Komponente \\
	...
	\makecell[l]{Interface ActionListener} & \makecell[l]{$\rhd$ Zugehörig zu \texttt{Button} \\
	...
	\makecell[l]{Klasse ActionEvent} & \makecell[l]{$\rhd$ Übergebener Parameter bei \texttt{actionPerformed} \\
	$\rhd$ Methoden: \\
	...
	\makecell[l]{Adapter} & \makecell[l]{$\rhd$ Verwendung von Adaptern, wenn passendes Interface nicht \texttt{functional} ist \\
	...
	\makecell[l]{Interface KeyListener} & \makecell[l]{$\rhd$ Abhorchen der Tastatur \\
	...
	\makecell[l]{Klasse KeyEvent} & \makecell[l]{$\rhd$ Übergebener Parameter bei z.B.: \texttt{keyPressed} \\
	$\rhd$ Methoden: \\
	...
	\hspace{0.4cm} $\diamond$ z.B.: \texttt{KeyEvent.VK\_BACKSPACE // Enter Taste} \\
	...
	\makecell[l]{Interface MouseListener} & \makecell[l]{$\rhd$ Abhorchen der Maus \\
	...
	\makecell[l]{Interface \\ MouseMotionListener} & \makecell[l]{$\rhd$ Abhorchen der Mausbewegung \\
	...
	\makecell[l]{Interface \\ MouseWheelListener} & \makecell[l]{$\rhd$ Abhorchen der Mausradbewegung \\
	$\rhd$ Methoden sind auch in Klasse \texttt{MouseAdapter} enthalten \\
	$\rhd$ Methoden: \\
	\hspace{0.4cm} $\diamond$ \texttt{public void mouseWheelMoved ( MouseWheelEvent event )}} \\ \hline

	\makecell[l]{Klasse MouseEvent} & \makecell[l]{$\rhd$ Übergebener Parameter bei z.B.: \texttt{mouseClicked} \\
	$\rhd$ Methoden: \\
	...
	\makecell[l]{Klasse \\ MouseWheelEvent} & \makecell[l]{$\rhd$ Übergebener Parameter bei z.B.: \texttt{mouseWheelMoved} \\
	$\rhd$ Methoden: \\
	\hspace{0.4cm} $\diamond$ \texttt{getWheelRotation()} \\
	\hspace{0.6cm} - Liefert die Anzahl der gedrehten "Ticks"  } \\ \hline

	\makecell[l]{Interface \\ WindowListener} & \makecell[l]{$\rhd$ Abhorchen von Fensteraktionen \\
	...
	\makecell[l]{Interface \\ WindowStateListener} & \makecell[l]{$\rhd$ Abhorchen des Status des Fensters \\
	...
	\makecell[l]{Interface \\ WindowFocusListener} & \makecell[l]{$\rhd$ Abhorchen des Fokus im Bezug auf das Fenster \\
	$\rhd$ Methoden sind auch in \texttt{WindowAdapter} vorhanden \\
	$\rhd$ Methoden: \\
	...
	\makecell[l]{Klasse Canvas} & \makecell[l]{$\rhd$ abgegrenzte Zeichenfläche in einem Fenster \\
	$\rhd$ Vorhergehensweise: \\
	...
	\makecell[l]{Klasse Checkbox} & \makecell[l]{$\rhd$ Kleiner Button (Pin) mit etwas Text \\
	...
	\makecell[l]{Interface \\ ItemListener} & \makecell[l]{$\rhd$ Zugehörig zu \texttt{Checkbox} \\
	$\rhd$ Funktionales Interface \\
	$\rhd$ Funktionale Methode \texttt{itemStateChanged (ItemEvent event)} \\
	$\rhd$ Vorhergehensweise analog zu \texttt{ActionListener} \\
	$\rhd$ Methoden: \\
	\hspace{0.4cm} $\diamond$ Aufruf auf an Klasse übergebene \texttt{Checkbox} \\
	\hspace{0.4cm} $\diamond$ \texttt{isSelected()} \\
	\hspace{0.6cm} - \texttt{true}, wenn die \texttt{Checkbox} an ist} \\ \hline

	\makecell[l]{Klasse Choice} & \makecell[l]{$\rhd$ Repräsentiert ein Auswahlmenü  } \\ \hline
...
\section{Klassen}
	...
	\makecell[l]{Verschachtelte Klassen} & \makecell[l]{$\rhd$ Einbettung von Klasse in andere Klasse \\
...
\section{Threads}
	...
	\makecell[l]{Interface Runnable} & \makecell[l]{$\rhd$ Aus Package \texttt{java.lang} \\
	...
	\makecell[l]{Klasse Thread} & \makecell[l]{$\rhd$ Aus Package \texttt{java.lang} \\
	...
	\makecell[l]{Threads und Streams} & \makecell[l]{$\rhd$ Verknüpfung zweier \texttt{Threads} mithilfe von \texttt{PipedInput(Output)Stream} \\
	...
	\makecell[l]{Interferiende Threads} & \makecell[l]{$\rhd$ Reihenfolge der Zugriffe, bei Zugriff auf die selbe Ressource, ungewiss \\
	$\rhd$ z.B.: Gleichzeitiges Schreiben auf \texttt{StdOut // Standard Out $\rightarrow$ System.out} } \\ \hline

	\makecell[l]{Thread terminieren} & \makecell[l]{$\rhd$ Beispiel: \\
	...
	\makecell[l]{Gründe für Threads} & \makecell[l]{$\rhd$ Parallelisierung \\
	...
	\makecell[l]{Parallelisierung von \\ Streams} & \makecell[l]{$\rhd$ Bereits implementiert, automatische, effiziente Aufteilung \\
