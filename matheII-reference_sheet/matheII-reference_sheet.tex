...
\subsubsection{Ableitungsregeln}
    ...
    \begin{tabularx}{\textwidth}{X m{16cm}}
        ...
        \midrule
              & \includegraphics[width=8cm]{ableitungen.png} \\
        \bottomrule
    \end{tabularx}
    \end{table}
...
\subsection{Differenzieren von Funktionen mehrerer Variablen - Partielle Ableitung}
    ...
    \begin{tabularx}{\textwidth}{X m{16cm}}
        ...
        6.4.1 & \includegraphics[width=8cm]{partAbl.png} \\
        \midrule
...
\subsection{Differenzieren von Funktionen mehrerer Variablen - Totale Differenzierbarkeit}
    ...
    \begin{tabularx}{\textwidth}{X m{16cm}}
        ...
        \midrule
        6.5.12& \includegraphics[width=8cm]{abspar.png} \\
        \midrule
...
\subsubsection{Definition des bestimmten Integrals}
    ...
    \begin{tabularx}{\textwidth}{X m{16cm}}
        ...
        6.7.7 & Es seien $a, b \in \mathbb{R}$ mit $a < b$ und integrierbare Funktionen $f,g: [a,b] \rightarrow \mathbb{R}$ gegeben.
                ...
                \end{itemize} \vspace{-0cm} \\
        \midrule
        6.7.8 & \textbf{Standardabschätzung} \hfill \break
        ...
        \midrule
        6.7.10& Es seien $a, b \in \mathbb{R}$ mit $a<b$. Jede stetige und jede monotone Funktion $f : [a,b] \rightarrow \mathbb{R}$
                ist integrierbar. \\  
...
\subsection{Problemstellung und Motivation}
    ...
    \begin{tabularx}{\textwidth}{X m{16cm}}
        ...
        \midrule
        7.1.4 & Fall von DGL der Ordnung $n$ immer auf Fall erster Ordnung ($n=1$) zurückspielbar. \hfill \break
        ...
        \midrule
        7.1.4 & Autonome DGL erster Ordnung: $y'(t) = f(y(t)),$ $t\in I$ \\
        \midrule
        7.1.4 & Stetig differenzierbare Funktion $y: I \rightarrow \mathbb{R}$, die DGL erfüllt: \textbf{Lösung der DGL} \\
        \midrule
        7.1.6 & DGLs im Allgemeinen mehrere Lösungen \hfill \break
...
\subsubsection{Getrennte Veränderliche}
    ...
    \begin{tabularx}{\textwidth}{X m{16cm}}
        ...
        7.2.2 & \textbf{Trennung der Variablen} \hfill \break
    ...
    \begin{tabularx}{\textwidth}{X m{16cm}}
        ...
        7.2.2 & Verwendung dieser Methode, falls eine DGL der Form $y'(t) = f(t,y(t))$ zu lösen ist, bei der die rechte Seite $f$ von der
...
\subsubsection{Lineare Systeme}
    ...
    \begin{tabularx}{\textwidth}{X m{16cm}}
        ...
        \midrule
        7.3.5 & Es seien $y_1, y_2, \dots, y_N \in C^1 (I; \mathbb{R}^N)$ Lösungen der Gleichung (7.2). Dann sind die folgenden
                Aussagen äquivalent: 
                \begin{itemize}[topsep=-0.5cm]
                ...
                \end{itemize} \vspace{-0cm} \\
        \midrule
        7.3.6 & Es seien $I \subseteq \mathbb{R}$ ein Intervall, sowie $A: I \rightarrow \mathbb{R}^{NxN}$ und $b: I \rightarrow \mathbb{R}^N$
    ...
    \begin{tabularx}{\textwidth}{X m{16cm}}
        ...
        7.3.1 & Das Ganze lässt sich in Matrixschreibweise um Einiges übersichtlicher schreiben. \\
