        ...
        \item \textbf{Analyse von MergeSort} 
            \begin{itemize}
                ...
                \item Lösen der Rekursionsgleichung mithilfe eines Rekursionsbaums
                    \begin{itemize}
                        \item[] \includegraphics[width=9cm]{mergeSortBaum.PNG}
        ...
        \item \textbf{Splay-Operationen}
            \begin{itemize}
                ...
                \item []
                    ...
                    \end{minted}
                \item[]
                \item[] \includegraphics[width=8cm]{zigzag.PNG}
                \item[] \includegraphics[width=8cm]{zigzig.PNG}
                \item[] \includegraphics[width=8cm]{zig.PNG}
            \end{itemize}
...
\pagebreak
        ...
        \item \textbf{Lösche Maximum}
            \begin{itemize}
                \item[1.] Ersetze Maximum durch \string"letztes\string" Blatt
    ...
    \begin{itemize}
        \item \textbf{Idee}
            \begin{itemize}
                \item[]
                    \begin{minipage}{0.4\textwidth}
                        \includegraphics[width=5cm]{hashtableIdee.PNG}
                    \end{minipage}
                    \begin{minipage}{0.5\textwidth}
                        \begin{itemize}
                ...
                \item[]
                    \begin{minipage}{0.4\textwidth}
                        \includegraphics[width=5cm]{hashtableLinkedList.PNG}
                    \end{minipage}
                    \begin{minipage}{0.5\textwidth}
                        \begin{itemize}
            ...
            \begin{itemize}
                \item \textit{Eigenschaften}
                    \begin{itemize}
                        ...
                        \item[] \includegraphics[width=9cm]{bitzähler.png}
                    \end{itemize}
                \item \textit{Inkrementieren eines Binärzählers}
                    \begin{itemize}
                        ...
                        \item \includegraphics[width=9cm]{increment.PNG}
                    \end{itemize}
                \item \textit{Teuerste INCREMENT-Operation}
                    \begin{itemize}
                        ...
                        \item \includegraphics[width=9cm]{incrementEXP.PNG}
                    \end{itemize}
            ...
            \begin{itemize}
                ...
                \item \textit{Durchführung}
                    \begin{itemize}
                        \item[]
                            \begin{minipage}{0.4\textwidth}
                                \includegraphics[width=7cm]{aggregat1.PNG}
                            \end{minipage}
                            \begin{minipage}{0.5\textwidth}
                                \includegraphics[width=7cm]{aggregat2.PNG}
                            \end{minipage}
                        \item[]
                            \begin{minipage}{0.4\textwidth}
                                \includegraphics[width=7cm]{aggregat3.PNG}
                            \end{minipage}
                            \begin{minipage}{0.5\textwidth}
                                \begin{itemize}
            ...
            \begin{itemize}
                ...
                \item \textit{Kostenbeispiel}
                    \begin{itemize}
                        ...
                        \item[] \includegraphics[width=9cm]{guthaben.PNG}
                    \end{itemize}
...
\pagebreak
            ...
            \item \textbf{P versus NP}
                \begin{itemize}
                    \item[] \includegraphics[width=12cm]{pnp.PNG}
                ...
                \begin{itemize}
                    \item \textit{Reduktionsidee}
                        \begin{itemize}
                            ...
                            \item[] \includegraphics[width=12cm]{reduktion1.PNG} 
                        \end{itemize}
                    ...
                    \item \textit{Formale Definition:}
                        \begin{itemize}
                            ...
                            \item[] \includegraphics[width=7cm]{reduktion2.PNG}
                        \end{itemize}
                \end{itemize}
                ...
                \begin{itemize}
                    \item \textit{Beschreibung}
                        \begin{itemize}
                            ...
                            \item[] \includegraphics[width=9cm]{tsp1.PNG}
                        \end{itemize}
                    \item \textit{Problem:} 
                        \begin{itemize}
                    ...
                    \item \textit{TSP ist NP-schwer}
                        \begin{itemize}
                            ...
                            \item[] \includegraphics[width=9cm]{schwer1.PNG}
                            \item $\Leftarrow$ Graph $G$ besitzt eine Tour $h'$ mit Kosten kleiner gleich 0
                            \item[] \includegraphics[width=9cm]{schwer2.PNG}
                        \end{itemize}
                \end{itemize}
